    ...
    <div className={styles.container}>
      ...
      <div className={styles.filters}>
        <div className={styles.searchBox}>
          <span>🔍</span>
          <input type="text" placeholder="Cari pesanan, customer, atau file..." className={styles.searchInput} />
        </div>
      ...
      <div className={styles.tableCard}>
        <div className={styles.tableHeader}>
          ...
          <span className={styles.tableCount}>{allHistory.length} pesanan ditemukan</span>
        </div>
        ...
        <div className={styles.pagination}>
          <span>Menampilkan <strong>{allHistory.length}</strong> dari <strong>{allHistory.length + 120}</strong> pesanan</span>
