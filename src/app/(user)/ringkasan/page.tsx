...
export default function RingkasanPage() {
  const { cart, removeFromCart, selectedLokasi, createOrder } = useApp();
  ...
  const handleConfirmPayment = () => {
    ...
    setTimeout(() => {
      ...
      // store last order id so client can look up live status from AppContext
      localStorage.setItem('kp_last_order_id', order.id);
