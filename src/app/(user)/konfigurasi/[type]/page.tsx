...
export default function KonfigurasiPage() {
  ...
  const canSubmit = file && nama.trim() && noTelp.trim();
        ...
        <div className={styles.rightCol}>
          <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div className={styles.section}>
              ...
              <input className="input-field" placeholder="Masukkan nama.." value={nama} onChange={e => setNama(e.target.value)} />
              <input className="input-field" placeholder="Masukkan nomor telp.." value={noTelp} onChange={e => setNoTelp(e.target.value)} style={{ marginTop: '10px' }} />
            </div>
          ...
          <div className={styles.summaryCard}>
            ...
            {!canSubmit && (
              <p className={styles.validationHint}>
                {!file ? '⚠ Unggah file terlebih dahulu' : '⚠ Lengkapi data diri (Nama & No. Telp)'}
              </p>
            )}
          </div>
        </div>
